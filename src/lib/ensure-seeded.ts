...
// Ensures the database has seed data. If the utility table is empty, runs the
// seed inline. This prevents the "search returns nothing / admin login fails"
// bug that happens when the SQLite file gets reset (e.g. by a fresh deploy or
...
async function runSeed(): Promise<void> {
  ...
  const contaminants = [
    ...
    },
    {
      ...
      legalLimit: 4, legalLimitUnit: 'ppt', healthGuideline: 0.1, healthGuidelineUnit: 'ppt', ewgHealthLimit: 0.1,
    ...
    },
    {
      ...
      legalLimit: 80, legalLimitUnit: 'ppb', healthGuideline: 0.15, healthGuidelineUnit: 'ppb', ewgHealthLimit: 0.15,
    ...
    },
    {
      ...
      legalLimit: 60, legalLimitUnit: 'ppb', healthGuideline: 0.1, healthGuidelineUnit: 'ppb', ewgHealthLimit: 0.1,
    ...
    },
    {
      ...
      legalLimit: 100, legalLimitUnit: 'ppb', healthGuideline: 0.02, healthGuidelineUnit: 'ppb', ewgHealthLimit: 0.02,
    ...
    },
    {
      ...
      legalLimit: 10, legalLimitUnit: 'ppm', healthGuideline: 0.14, healthGuidelineUnit: 'ppm', ewgHealthLimit: 0.14,
    ...
    },
    {
      ...
      legalLimit: 3, legalLimitUnit: 'ppb', healthGuideline: 0.15, healthGuidelineUnit: 'ppb', ewgHealthLimit: 0.15,
    ...
    },
    {
      ...
      legalLimit: 30, legalLimitUnit: 'ppb', healthGuideline: 0.43, healthGuidelineUnit: 'ppb', ewgHealthLimit: 0.43,
    ...
    },
    {
      ...
      legalLimit: 4, legalLimitUnit: 'ppm', healthGuideline: 0.4, healthGuidelineUnit: 'ppm', ewgHealthLimit: 0.4,
  ...
  const utilities = [
    ...
    { pwsid: 'CA1910052', name: 'Los Angeles Department of Water and Power', city: 'Los Angeles', state: 'CA', zipCodes: '90001,90002,90003,90004,90005,90006,90007,90008,90011,90012,90013,90015,90017,90019,90020,90024,90026,90028,90042,90048', county: 'Los Angeles', population: 3902000, systemType: 'Community', sourceType: 'Mixed', treatmentStatus: 'Treated', latitude: 34.0522, longitude: -118.2437, website: 'https://www.ladwp.com', notes: 'Sources: LA Aqueduct (Owens Valley), California Aqueduct, Colorado River Aqueduct, local groundwater.' },
    { pwsid: 'TX1010337', name: 'City of Houston Public Works', city: 'Houston', state: 'TX', zipCodes: '77001,77002,77003,77004,77005,77006,77007,77008,77009,77010,77011,77012,77013,77014,77015,77016,77018,77019,77020,77021', county: 'Harris', population: 2303000, systemType: 'Community', sourceType: 'Surface', treatmentStatus: 'Treated', latitude: 29.7604, longitude: -95.3698, website: 'https://www.publicworks.houstontx.gov', notes: 'Sources: Lake Houston, Lake Conroe, Trinity River.' },
    { pwsid: 'AZ0413027', name: 'City of Phoenix Water Services Department', city: 'Phoenix', state: 'AZ', zipCodes: '85001,85002,85003,85004,85006,85007,85008,85009,85012,85013,85014,85015,85016,85017,85018,85019,85020,85021,85022,85023', county: 'Maricopa', population: 1626000, systemType: 'Community', sourceType: 'Mixed', treatmentStatus: 'Treated', latitude: 33.4484, longitude: -112.074, website: 'https://www.phoenix.gov/waterservices', notes: 'Sources: Salt River Project, Colorado River (via CAP), and groundwater.' },
    { pwsid: 'PA1510001', name: 'Philadelphia Water Department', city: 'Philadelphia', state: 'PA', zipCodes: '19102,19103,19104,19106,19107,19111,19114,19115,19116,19118,19119,19120,19121,19122,19123,19124,19125,19127,19128,19129', county: 'Philadelphia', population: 1574000, systemType: 'Community', sourceType: 'Surface', treatmentStatus: 'Treated', latitude: 39.9526, longitude: -75.1652, website: 'https://www.phila.gov/water', notes: 'Sources: Schuylkill and Delaware Rivers.' },
    { pwsid: 'FL6020055', name: 'Miami-Dade Water and Sewer Department', city: 'Miami', state: 'FL', zipCodes: '33101,33109,33110,33124,33125,33126,33127,33128,33129,33130,33131,33132,33133,33134,33135,33136,33137,33138,33139,33140', county: 'Miami-Dade', population: 2356000, systemType: 'Community', sourceType: 'Ground', treatmentStatus: 'Treated', latitude: 25.7617, longitude: -80.1918, website: 'https://www.miamidade.gov/water', notes: 'Sources: Biscayne Aquifer (groundwater).' },
  ...
  for (const u of utilities) {
    const created = await db.utility.upsert({ where: { pwsid: u.pwsid }, update: u, create: u })
