...
const FAQS: FAQItem[] = [
  ...
  { id: 'd2', category: 'Data', question: 'How accurate is the data?', answer: 'Each record should be read with its source and review state. Citizen and otherwise unreviewed observations remain separate from reviewed institutional evidence and do not establish a safety finding. Where review metadata is unavailable, the site shows an unassessed state instead of treating the record as verified.' },
  { id: 'd3', category: 'Data', question: 'What is the water safety score?', answer: 'A safety score is only available when there is enough reviewed, eligible evidence to calculate one. Missing or unreviewed records do not receive a score and do not default to “within guidelines.” When a score is available, read the underlying contaminant comparisons, units, dates, and sources alongside it.' },
  { id: 'd4', category: 'Data', question: 'Can I submit my own reading?', answer: 'Yes. Use the Submit Reading page to add a measured observation with its source, location, units, and reporter information. New community submissions are labeled as Citizen readings and enter the review queue; they are not automatically treated as reviewed regulatory or laboratory evidence. Rate limit: 10 readings per email per 24 hours.' },
