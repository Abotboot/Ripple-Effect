...
type FAQItem = {
  ...
  question: string
  answer: string
  category: 'General' | 'Microplastics' | 'Data' | 'Health' | 'Chapters'
}

const FAQS: FAQItem[] = [
  // General
  { id: 'g1', category: 'General', question: 'What is A Ripples Effect?', answer: 'A Ripples Effect is a community-built tap water and microplastics database. We collect, organize, and publish water quality data so anyone can see what is in their drinking water — including microplastics, which almost no other public database tracks. We are a volunteer non-profit running the 2026 Water Project.' },
  { id: 'g2', category: 'General', question: 'Is the data free to use?', answer: 'Yes. All data in this database is open and freely downloadable. Use the Download open data link in the footer to export utilities, contaminants, samples, and reports as CSV or JSON. We ask that you credit A Ripples Effect and link back to the site when possible.' },
  { id: 'g3', category: 'General', question: 'How is this different from the EWG Tap Water Database?', answer: 'EWG is a great resource and one of our data sources. The key difference: we track microplastics, which EWG does not. We also accept citizen-submitted readings, show a water safety score per utility, and provide a national dashboard with score distributions and state rankings. Think of us as EWG + microplastics + community science.' },
  ...
  { id: 'm3', category: 'Microplastics', question: 'How do microplastics get into drinking water?', answer: 'Microplastics enter water systems from many sources: breakdown of plastic packaging, synthetic textile fibers shed during washing, tire wear particles washed into waterways, microbeads (now banned in rinse-off cosmetics but persisting in the environment), and degradation of larger plastic debris. Conventional water treatment removes a significant fraction but not all — some particles are too small to filter out.' },
  { id: 'm4', category: 'Microplastics', question: 'What is the microplastics identifier?', answer: 'The microplastics identifier is a low-cost device our crew is designing. Chapters receive a kit, dip the identifier into local water (tap, stream, reservoir), and the reading flows into this public database. A companion mobile app is planned so chapters can push readings directly from the field.' },
  ...
  { id: 'd4', category: 'Data', question: 'Can I submit my own reading?', answer: 'Yes! Use the Submit Reading page. You will need a microplastics identifier (from a chapter kit or your own setup), select the contaminant and utility, enter the measured level, and provide your name and email for verification. Your reading is tagged as Citizen quality and appears in the database immediately. Rate limit: 10 readings per email per 24 hours.' },
  ...
  // Chapters
  { id: 'c1', category: 'Chapters', question: 'What is a chapter?', answer: 'A chapter is a local group that takes our microplastics identifier and tests water in their area. Chapters receive a kit (identifier unit, sample vials, testing protocol), dip it into their local tap, stream, or reservoir, and push readings into this public database. Chapters are ranked on our leaderboard by community impact.' },
  { id: 'c2', category: 'Chapters', question: 'How do I start a chapter?', answer: 'Go to the Start a Chapter page and fill out the form. Tell us your city and the water body you want to test. Our chapter lead will reach out within a week with kit details and onboarding. No coding or special expertise required — just curiosity and a few minutes a week.' },
  { id: 'c3', category: 'Chapters', question: 'Do I need to be a scientist to start a chapter?', answer: 'No. The identifier kit comes with a step-by-step protocol. If you can collect a water sample in a clean container and read a number off a device, you can contribute. We provide the kit, the protocol, and the data-entry tools. Students, community groups, and curious individuals are all welcome.' },
  { id: 'c4', category: 'Chapters', question: 'Is the chapter kit free?', answer: 'Kits are free for student and community chapters while supplies last, funded by donations. If you can contribute, the Donate page supports our crowdfunding campaign for more kits and testing supplies.' },
]
...
const CATEGORY_CONFIG: Record<FAQItem['category'], { icon: React.ElementType; color: string }> = {
  ...
  Chapters: { icon: Heart, color: 'bg-rose-100 text-rose-700 dark:bg-rose-950/50 dark:text-rose-300' },
}
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-pretty text-base text-white/90 sm:text-lg">
              Everything you need to know about A Ripples Effect, microplastics,
              water quality data, and starting a chapter.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <Card className="mt-10 border-primary/20 bg-primary/5">
          <CardContent className="flex flex-col items-center gap-4 p-6 text-center sm:flex-row sm:text-left">
            ...
            <a
              href="mailto:rippleeffectoffice@gmail.com?subject=Question%20about%20A%20Ripples%20Effect"
